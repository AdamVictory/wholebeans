...
class RecipeList(generic.ListView):
    """View to show list of all recipes"""
    model = Recipe
...
class UserRecipe(generic.ListView):
    """View to display recipes created by logged in users"""
...
def search_results(request):
    """function to search recipe by title"""
